...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, Factorymod.MODID, existingFileHelper);
    }
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = Factorymod.MODID;
        ...
        if (itemRegistryObject.get() instanceof ArmorItem armorItem) {
            trimMaterials.entrySet().forEach(entry -> {
                ...
                String armorItemPath = "item/" + armorType;
    ...
    public void evenSimplerBlockItem(RegistryObject<Block> block) {
        this.withExistingParent(Factorymod.MODID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
